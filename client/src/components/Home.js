 ...
 function Home( {user, loggedInUser}) {
    ...
    return (
        ...
        <div className="home_container" >
           ...
           classes (feel free to use fake credit card information) and practice your scales on a virtual piano! 
           And to really hone in your skills, sign up for a one on one session with the man himself, William!
           </h5>
