 ...
 function Home( {user, loggedInUser}) {
    ...
    return (
        ...
        <div className="home_container" >
           ...
           <h5 className="home_info">At Piano with William you are able to purchase premium follow along classes and practice your scales on a virtual piano! And to really hone in your skills, sign up for a one on one session with the man himself, William!</h5>
