...
PrivateClass.create(goal:"get better", date:"20211225090000", user_id:donald.id)
PrivateClass.create(goal:"play", date:"20211225090000", user_id:bugs.id)
PrivateClass.create(goal:"learn", date:"20211225090000", user_id:donald.id)
PrivateClass.create(goal:"learn that song", date:"20211225090000", user_id:donald.id)

onlineClass1 = OnlineClass.create(name:"Learn Happy B Day", description:"note for note walkthrough", price:"1.99", difficulty:"easy", video:"rOqQIxeLKVQ", available: true )
onlineClass2 = OnlineClass.create(name:"blues scale", description:"how to improvise", price:"2.99", difficulty:"intermediate", video:"rOqQIxeLKVQ", available: true )
onlineClass3 = OnlineClass.create(name:"anomolie chords", description:"chord walkthrough", price:"3.99", difficulty:"advanced", video:"rOqQIxeLKVQ", available: true )
