...
onlineClass4 = OnlineClass.create(name:"Earned It - The Weekend", description:"note for note tutorial", price:"2.50", difficulty:"intermediate", video:"8nXXMPyZNe0", available: true, image: "https://upload.wikimedia.org/wikipedia/en/3/38/The_Weeknd_-_Earned_It.png"  )
